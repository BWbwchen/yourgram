...
import (
	...
	"strconv"
	"syscall"
	"yourgram/view_image/health"
	"yourgram/view_image/pb"

	"yourgram/view_image/service"
...
func main() {
	...
	viewImageService := service.NewService(logger)
	...
	go func() {
		...
		pb.RegisterViewImageServiceServer(baseServer, viewImageService)
